-- ═══════════════════════════════════════════════════════════════════════════════════════════════
-- DÉMONSTRATION — retrait de la ligne « [DÉMO] » posée par ligne-prestations-intellectuelles-100328.sql (plan 100328).
--
...
--
-- Usage : psql -U postgres -d DBPRS20 -f docs/demo/ligne-prestations-intellectuelles-100328-retrait.sql
-- ═══════════════════════════════════════════════════════════════════════════════════════════════

BEGIN;

CREATE TEMP TABLE demo_ligne ON COMMIT DROP AS
    SELECT "ID_DETAIL" FROM public.t_marche WHERE "DESIGNATION_MARCHE" = '[DÉMO] Étude de faisabilité et assistance à maîtrise d''ouvrage' AND "ID_DOSSIER" = 100328;
