-- ═══════════════════════════════════════════════════════════════════════════════════════════════
-- DÉMONSTRATION — retrait de la ligne « [DÉMO] » posée par ligne-a-commande-100328.sql (plan 100328).
--
...
--
-- Usage : psql -U postgres -d DBPRS20 -f docs/demo/ligne-a-commande-100328-retrait.sql
-- ═══════════════════════════════════════════════════════════════════════════════════════════════

BEGIN;

CREATE TEMP TABLE demo_ligne ON COMMIT DROP AS
    SELECT "ID_DETAIL" FROM public.t_marche WHERE "DESIGNATION_MARCHE" LIKE '[DÉMO]%' AND "ID_DOSSIER" = 100328;
