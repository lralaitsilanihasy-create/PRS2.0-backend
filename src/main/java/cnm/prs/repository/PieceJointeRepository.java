...
public interface PieceJointeRepository extends JpaRepository<PieceJointe, Integer> {
    ...
    // ⚠️ RETIRÉ le 2026-09-17 (§B4, migration V31) — « premierDepotDesComptes » dérivait l'ancienneté de
    // la file des inscriptions de la première pièce jointe déposée, faute de date de dépôt sur
    // t_compte_auth (B1 interdisait toute migration). V31 ayant posé DATE_DEMANDE et repris l'existant,
    // la dérivation est remplacée par une lecture : CompteAuthRepository.premiereDemande.
